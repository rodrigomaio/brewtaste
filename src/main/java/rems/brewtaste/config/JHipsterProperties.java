...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "brewtaste@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "brewtaste API";

        private String description = "brewtaste API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "brewtaste";
