...
import rems.brewtaste.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("rems.brewtaste.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("rems.brewtaste.repository.search")
