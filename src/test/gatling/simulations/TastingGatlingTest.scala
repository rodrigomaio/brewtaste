...
/**
 * Performance test for the Tasting entity.
 */
class TastingGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Tasting entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created tasting")
                .get("${new_tasting_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created tasting")
            .delete("${new_tasting_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
